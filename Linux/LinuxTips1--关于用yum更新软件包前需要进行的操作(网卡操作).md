# LinuxTips1--关于用yum更新软件包前需要进行的操作(网卡操作)

  若进行软件包更新可能会出现如下错误：

 **Cannot find a valid baseul for repo:base/7/*86 64**

 ![](https://img-blog.csdnimg.cn/20190419201505899.PNG?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3poYWFuZHpoYQ==,size_16,color_FFFFFF,t_70)

1.  保证网络连接为NAT模式

2. 激活网卡

   需要回到 /etc/sysconfig/network-scripts目录下，更改ifcfg-ens33文件：

​       ![](https://img-blog.csdnimg.cn/20190419201812958.PNG)
