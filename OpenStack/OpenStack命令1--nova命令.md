...
+ 查看现有可用域
  ...
  | internal              | available                              |
  | |- controller         |                                        |
  | | |- nova-conductor   | enabled :-) 2020-10-20T02:56:23.000000 |
  | | |- nova-scheduler   | enabled :-) 2020-10-20T02:56:25.000000 |
  | | |- nova-consoleauth | enabled :-) 2020-10-20T02:56:26.000000 |
  | nova                  | available                              |
  | |- compute            |                                        |
  | | |- nova-compute     | enabled :-) 2020-10-20T02:56:19.000000 |
  | |- compute2           |                                        |
  | | |- nova-compute     | enabled :-) 2020-10-20T02:56:19.000000 |
  +-----------------------+----------------------------------------+
  ```
...
+ 更新主机聚合的名称和可选的可用域
  ...
  ```bash
  nova aggregate-update *aggregate* *name* [*availability-zone*]
  ```

  + aggregate : 聚合名称或ID
  + name : 新的聚合名
  + availability-zone : 新的聚合对应的可用域
